    ...
    function paparesults(results){
      ...
      $.each( results, function( key, value ) {
        if( value['vertical'] == $.cookie('verticalcategory') ){
          $('.swiper-wrapper').append('<div class="swiper-slide"> <div class="product-slide"> <h1>'+ value['name'] +'</h1> <img src="'+ value['imagefilename'] +'" alt="" /> <p>'+ value['description'] +'</p> <div class="datasheet-download-btn"><a href="'+ value['pdf'] +'" title="">Share Datasheet</a></div></div></div>'
          );
        }
      });
